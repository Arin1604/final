...
void Realtime::addParticle(float x, float y, float z){
...
void Realtime::initializeGL() {
    ...
    for(int i = 0; i < particles.size(); i++){
        std::cout << particles[i].offset[0] << std::endl;
    }
...
void Realtime::paintSnow(GLuint texture, glm::mat4 view, glm::mat4 proj, glm::vec3 offset, Particle currPart){
    ...
    if(isDissolved){
    std::cout << "Updated incrementer" << currPart.particleIncrementor<< std::endl;
    }
